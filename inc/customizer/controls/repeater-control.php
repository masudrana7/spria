...
if ( class_exists( 'WP_Customize_Control' ) ) {
    class Customizer_Sortable_Repeater_Control extends WP_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_script('softcoderstheme-custom-controls-js', trailingslashit(get_template_directory_uri()) . 'assets/js/customizer.js', array('jquery', 'jquery-ui-core'), '1.2', true);
