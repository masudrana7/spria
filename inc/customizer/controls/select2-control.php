<?php
namespace SoftCoders\spria\Customizer\Controls;
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    class Customizer_Dropdown_Select2_Control extends WP_Customize_Control {
        ...
        public function enqueue() {
            wp_enqueue_script( 'softcoderstheme-select2-js', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/assets/select2.min.js', array( 'jquery' ), '4.0.6', true );
            wp_enqueue_script( 'softcoderstheme-custom-controls-js', trailingslashit( get_template_directory_uri() ) . 'assets/js/customizer.js', array( 'softcoderstheme-select2-js' ), '1.2', true );
            wp_enqueue_style( 'softcoderstheme-select2-css', trailingslashit( get_template_directory_uri() ) . 'inc/customizer/assets/select2.min.css', array(), '4.0.6', 'all' );
            wp_enqueue_style( 'softcoderstheme-custom-controls-css', trailingslashit( get_template_directory_uri() ) . 'assets/css/customizer.css', array(), '1.1', 'all' );
        }
        /**
